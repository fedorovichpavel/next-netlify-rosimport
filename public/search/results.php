...
<script type="text/javascript">
	...
	?>
			<li>
				...
				<span class="match">НАЙДЕНО: <?php echo count($final_result[$i]['search_result']); ?> - URL: <?php echo $final_result[$i]['file_name'][0]; ?></span>
			</li>
	<?php
			}
		}
		if ($match_count == 0) {
			echo '<h5>Не найдено: <span class="search">'.$search_term.'</span></h5>';
		}
	?>
		</ol>
	</div>
